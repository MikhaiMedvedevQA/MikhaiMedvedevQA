...
Это [конвейер](https://github.com/MikhaiMedvedevQA/QA_Vibe-coding), который обезличивает конфиденциальные данные в спецификациях и описаниях продуктов для  страхового B2B и генерирует по ним чек-листы и тест-кейсы для ручного тестирования.
...
**Анонимайзер (custom tool):** PyMuPDF, python-docx, openpyxl, pandoc, tkinter.
